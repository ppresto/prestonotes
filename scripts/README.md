...
- **`ucn-planner-preflight.py`** — validates planner contract on mutation JSON before UCN `write_doc` / `write`. **When to run, exit codes, and full matrix:** [`docs/ai/playbooks/update-customer-notes.md`](../docs/ai/playbooks/update-customer-notes.md) (Step 10 / TASK-072).
