...
2. [ ] **TASK-047** — Retire Journey Timeline; scrub harness vocab; enrich Account Summary — [`active/TASK-047-retire-journey-timeline-into-account-summary.md`](active/TASK-047-retire-journey-timeline-into-account-summary.md) · deletes a write-only artifact, folds narrative into Account Summary, defines `FORBIDDEN_EVIDENCE_TERMS` reused by 048/049/050.
3. [ ] **TASK-048** — Challenge lifecycle write discipline (+ Challenge Tracker row date bullet) — [`active/TASK-048-challenge-lifecycle-write-discipline.md`](active/TASK-048-challenge-lifecycle-write-discipline.md) · fixes call-date vs run-date bug across **both** `update_challenge_state` and GDoc Challenge Tracker row writes; forbids stub / harness evidence at MCP write time.
