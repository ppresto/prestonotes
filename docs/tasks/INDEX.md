...
- **TASK-052** — E2E `_TEST_CUSTOMER` harness: `prep-v1` / `prep-v2`, `e2e_rebaseline_customer_gdoc.py`, push-before-pull, `materialize --v2`, playbook + CI parity; **deferred** full uninterrupted catalog-default proof + §J.3+ → **TASK-053** / **TASK-044** — [`archive/2026-04/TASK-052-e2e-test-customer-drive-sync-and-artifact-survival.md`](archive/2026-04/TASK-052-e2e-test-customer-drive-sync-and-artifact-survival.md) (2026-04-23)
...
- **TASK-044** — E2E `_TEST_CUSTOMER` harness rebuild (closed outside file; harness SSoT is `scripts/lib/e2e-catalog.txt` + `tester-e2e-ucn.md` procedure) — [`archive/2026-04/TASK-044-e2e-test-customer-rebuild.md`](archive/2026-04/TASK-044-e2e-test-customer-rebuild.md) (archived 2026-04-24)
