...
4. **Rewire** — Playbooks (especially `update-customer-notes.md`), E2E guide, `project_spec.md`, `.cursor/rules` (orchestrator, extractor, core), Python docstrings that cited the monolith, CI `required-paths.manifest`, and related tasks now cite **`docs/ai/gdoc-customer-notes/`** (hub or the specific `mutations-*.md` file).
...
- [x] **`docs/ai/playbooks/update-customer-notes.md`** and **`docs/E2E_TEST_CUSTOMER_GUIDE.md`** cite the hub and/or the correct pack.
